...
cusparseStatus_t CUSPARSEAPI cusparseScsrilu02_numericBoost(
    ...
    float *boost_val) {
  LOAD_SPARSE_SYMBOL_FOR_ONCE(CUSPARSE_LIB_11_3,
...
cusparseStatus_t CUSPARSEAPI cusparseHpruneDense2csrByPercentage_bufferSizeExt(
  ...
  LOAD_SPARSE_SYMBOL_FOR_ONCE(
      CUSPARSE_LIB_11_3, cusparseHpruneDense2csrByPercentage_bufferSizeExt);
  LOG(TRACE, "Enter %s()", __FUNCTION__);
...
cusparseStatus_t CUSPARSEAPI cusparseSpruneDense2csrByPercentage_bufferSizeExt(
    ...
    const int *csrSortedColIndC, pruneInfo_t info, size_t *pBufferSizeInBytes) {
  LOAD_SPARSE_SYMBOL_FOR_ONCE(
      CUSPARSE_LIB_11_3, cusparseSpruneDense2csrByPercentage_bufferSizeExt);
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, A, lda, percentage, descrC, csrSortedValC,
                   csrSortedRowPtrC, csrSortedColIndC, info,
                   pBufferSizeInBytes);
...
cusparseStatus_t CUSPARSEAPI cusparseDpruneDense2csrByPercentage_bufferSizeExt(
    ...
    const int *csrSortedColIndC, pruneInfo_t info, size_t *pBufferSizeInBytes) {
  LOAD_SPARSE_SYMBOL_FOR_ONCE(
      CUSPARSE_LIB_11_3, cusparseDpruneDense2csrByPercentage_bufferSizeExt);
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, A, lda, percentage, descrC, csrSortedValC,
                   csrSortedRowPtrC, csrSortedColIndC, info,
                   pBufferSizeInBytes);
...
cusparseStatus_t CUSPARSEAPI cusparseSpMatGetAttribute(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spMatDescr, attribute, data, dataSize);
}
...
cusparseStatus_t CUSPARSEAPI cusparseCreateCsc(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spMatDescr, rows, cols, nnz, cscColOffsets, cscRowInd,
...
cusparseCscSetPointers(cusparseSpMatDescr_t spMatDescr, void *cscColOffsets,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spMatDescr, cscColOffsets, cscRowInd, cscValues);
}
...
cusparseCooSetPointers(cusparseSpMatDescr_t spMatDescr, void *cooRows,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spMatDescr, cooRows, cooColumns, cooValues);
}
...
cusparseStatus_t CUSPARSEAPI cusparseCreateBlockedEll(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spMatDescr, rows, cols, ellBlockSize, ellCols, ellColInd,
...
cusparseStatus_t CUSPARSEAPI cusparseSparseToDense_bufferSize(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, matA, matB, alg, bufferSize);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSparseToDense(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, matA, matB, alg, buffer);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSpSV_bufferSize(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, opA, alpha, matA, vecX, vecY, computeType, alg,
